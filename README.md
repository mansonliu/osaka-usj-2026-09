...
## 四、逐日行程（9/24→9/27，4 天 3 夜，全程住 Hotel Keihan Universal Tower）

> 機票、飯店已訂定（長榮 BR0178 去／BR0129 回）。**USJ 兩天（9/25、9/26）兩案相同，只寫一次；頭尾兩天（9/24 抵達、9/27 離開）提供 A／B 兩案，差別在「市區半天放哪」。**
> 🕐 時區：大阪比台灣快 1 小時。航班時刻為各機場當地時間（TPE 台灣時間／KIX 日本時間）；**在大阪期間的行程一律標 JST（日本時間）。**

### 已訂航班
- 去程 **9/24（四）BR0178**：TPE 06:30（台灣）→ KIX 約 09:55–10:10（JST），早班。
- 回程 **9/27（日）BR0129**：KIX 約 17:45–18:10（JST）→ TPE 約 20:05–20:25（台灣），傍晚班。
...
> 📌 **本節為歷史比價（定案＝9/24→9/27，已訂長榮）**，僅供存查；此處「方案 A／B」指**出發日**，與第四節「方案 A／B＝市區半天放哪」不同，勿混淆。價格討論已結束。
